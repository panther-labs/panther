...
describe('BulkUploader', () => {
  ...
  it('allows dropping a file', async () => {
    ...
    const { container, getByTestId, getByText } = render(<BulkUploader />);

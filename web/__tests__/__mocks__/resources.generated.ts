...
export const mockActiveSuppressCount = (
...
export const mockAddComplianceIntegrationInput = (
...
export const mockAddGlobalPythonModuleInput = (
...
export const mockAddPolicyInput = (overrides?: Partial<AddPolicyInput>): AddPolicyInput => {
  return {
    autoRemediationId:
    ...
    tests:
      overrides && overrides.hasOwnProperty('tests')
        ? overrides.tests!
        : [mockPolicyUnitTestInput()],
  };
};

export const mockAddRuleInput = (overrides?: Partial<AddRuleInput>): AddRuleInput => {
  return {
...
export const mockAddS3LogIntegrationInput = (
...
export const mockAlertDetails = (overrides?: Partial<AlertDetails>): AlertDetails => {
  return {
...
export const mockAlertSummary = (overrides?: Partial<AlertSummary>): AlertSummary => {
  return {
...
export const mockAsanaConfig = (overrides?: Partial<AsanaConfig>): AsanaConfig => {
  return {
...
export const mockAsanaConfigInput = (overrides?: Partial<AsanaConfigInput>): AsanaConfigInput => {
  return {
    personalAccessToken:
      overrides && overrides.hasOwnProperty('personalAccessToken')
        ? overrides.personalAccessToken!
...
export const mockComplianceIntegration = (
  ...
  return {
    ...
    auditRoleStatus:
      overrides && overrides.hasOwnProperty('auditRoleStatus')
        ...
        : mockIntegrationItemHealthStatus(),
    cweRoleStatus:
...
export const mockComplianceItem = (overrides?: Partial<ComplianceItem>): ComplianceItem => {
  return {
...
export const mockComplianceStatusCounts = (
...
export const mockCustomWebhookConfig = (
...
export const mockCustomWebhookConfigInput = (
...
export const mockDeleteGlobalPythonInputItem = (
...
export const mockDeleteGlobalPythonModuleInput = (
  ...
  return {
    globals:
      overrides && overrides.hasOwnProperty('globals')
        ? overrides.globals!
        : [mockDeleteGlobalPythonInputItem()],
  };
};

export const mockDeletePolicyInput = (
  ...
  return {
    policies:
      overrides && overrides.hasOwnProperty('policies')
        ? overrides.policies!
        : [mockDeletePolicyInputItem()],
  };
};

export const mockDeletePolicyInputItem = (
...
export const mockDeleteRuleInput = (overrides?: Partial<DeleteRuleInput>): DeleteRuleInput => {
  return {
    rules:
      overrides && overrides.hasOwnProperty('rules')
        ? overrides.rules!
        : [mockDeleteRuleInputItem()],
  };
};

export const mockDeleteRuleInputItem = (
...
export const mockDestination = (overrides?: Partial<Destination>): Destination => {
  return {
...
export const mockDestinationConfig = (
  overrides?: Partial<DestinationConfig>
): DestinationConfig => {
  return {
    __typename: 'DestinationConfig',
    slack: overrides && overrides.hasOwnProperty('slack') ? overrides.slack! : mockSlackConfig(),
    sns: overrides && overrides.hasOwnProperty('sns') ? overrides.sns! : mockSnsConfig(),
    sqs: overrides && overrides.hasOwnProperty('sqs') ? overrides.sqs! : mockSqsConfig(),
    pagerDuty:
      overrides && overrides.hasOwnProperty('pagerDuty')
        ? overrides.pagerDuty!
        : mockPagerDutyConfig(),
    github:
      overrides && overrides.hasOwnProperty('github') ? overrides.github! : mockGithubConfig(),
    jira: overrides && overrides.hasOwnProperty('jira') ? overrides.jira! : mockJiraConfig(),
    opsgenie:
      overrides && overrides.hasOwnProperty('opsgenie')
        ? overrides.opsgenie!
        : mockOpsgenieConfig(),
    msTeams:
      overrides && overrides.hasOwnProperty('msTeams') ? overrides.msTeams! : mockMsTeamsConfig(),
    asana: overrides && overrides.hasOwnProperty('asana') ? overrides.asana! : mockAsanaConfig(),
    customWebhook:
      overrides && overrides.hasOwnProperty('customWebhook')
        ? overrides.customWebhook!
        : mockCustomWebhookConfig(),
  };
};

export const mockDestinationConfigInput = (
  overrides?: Partial<DestinationConfigInput>
): DestinationConfigInput => {
  return {
    slack:
      overrides && overrides.hasOwnProperty('slack') ? overrides.slack! : mockSlackConfigInput(),
    sns: overrides && overrides.hasOwnProperty('sns') ? overrides.sns! : mockSnsConfigInput(),
    sqs: overrides && overrides.hasOwnProperty('sqs') ? overrides.sqs! : mockSqsConfigInput(),
    pagerDuty:
      overrides && overrides.hasOwnProperty('pagerDuty')
        ? overrides.pagerDuty!
        : mockPagerDutyConfigInput(),
    github:
      overrides && overrides.hasOwnProperty('github') ? overrides.github! : mockGithubConfigInput(),
    jira: overrides && overrides.hasOwnProperty('jira') ? overrides.jira! : mockJiraConfigInput(),
    opsgenie:
      overrides && overrides.hasOwnProperty('opsgenie')
        ? overrides.opsgenie!
        : mockOpsgenieConfigInput(),
    msTeams:
      overrides && overrides.hasOwnProperty('msTeams')
        ? overrides.msTeams!
        : mockMsTeamsConfigInput(),
    asana:
      overrides && overrides.hasOwnProperty('asana') ? overrides.asana! : mockAsanaConfigInput(),
    customWebhook:
      overrides && overrides.hasOwnProperty('customWebhook')
        ? overrides.customWebhook!
        : mockCustomWebhookConfigInput(),
  };
};

export const mockDestinationInput = (overrides?: Partial<DestinationInput>): DestinationInput => {
  return {
    outputId:
      overrides && overrides.hasOwnProperty('outputId')
        ? overrides.outputId!
...
export const mockGeneralSettings = (overrides?: Partial<GeneralSettings>): GeneralSettings => {
  return {
...
export const mockGetAlertInput = (overrides?: Partial<GetAlertInput>): GetAlertInput => {
  return {
    alertId:
      overrides && overrides.hasOwnProperty('alertId')
        ? overrides.alertId!
...
export const mockGetComplianceIntegrationTemplateInput = (
...
export const mockGetGlobalPythonModuleInput = (
...
export const mockGetPolicyInput = (overrides?: Partial<GetPolicyInput>): GetPolicyInput => {
  return {
    policyId:
      overrides && overrides.hasOwnProperty('policyId')
        ? overrides.policyId!
...
export const mockGetResourceInput = (overrides?: Partial<GetResourceInput>): GetResourceInput => {
  return {
    resourceId:
      overrides && overrides.hasOwnProperty('resourceId')
        ? overrides.resourceId!
...
export const mockGetRuleInput = (overrides?: Partial<GetRuleInput>): GetRuleInput => {
  return {
    ruleId:
      overrides && overrides.hasOwnProperty('ruleId')
        ? overrides.ruleId!
...
export const mockGetS3LogIntegrationTemplateInput = (
...
export const mockGithubConfig = (overrides?: Partial<GithubConfig>): GithubConfig => {
  return {
...
export const mockGithubConfigInput = (
...
export const mockGlobalPythonModule = (
...
export const mockIntegrationItemHealthStatus = (
...
export const mockIntegrationTemplate = (
...
export const mockInviteUserInput = (overrides?: Partial<InviteUserInput>): InviteUserInput => {
  return {
...
export const mockJiraConfig = (overrides?: Partial<JiraConfig>): JiraConfig => {
  return {
...
export const mockJiraConfigInput = (overrides?: Partial<JiraConfigInput>): JiraConfigInput => {
  return {
    orgDomain:
...
export const mockListAlertsInput = (overrides?: Partial<ListAlertsInput>): ListAlertsInput => {
  return {
    ruleId:
      overrides && overrides.hasOwnProperty('ruleId')
        ? overrides.ruleId!
...
export const mockListAlertsResponse = (
...
export const mockListComplianceItemsResponse = (
  overrides?: Partial<ListComplianceItemsResponse>
): ListComplianceItemsResponse => {
  return {
    __typename: 'ListComplianceItemsResponse',
    items:
      overrides && overrides.hasOwnProperty('items') ? overrides.items! : [mockComplianceItem()],
    paging: overrides && overrides.hasOwnProperty('paging') ? overrides.paging! : mockPagingData(),
    status:
      overrides && overrides.hasOwnProperty('status')
        ? overrides.status!
        : ComplianceStatusEnum.Error,
    totals:
      overrides && overrides.hasOwnProperty('totals')
        ? overrides.totals!
        : mockActiveSuppressCount(),
  };
};

export const mockListGlobalPythonModuleInput = (
...
export const mockListGlobalPythonModulesResponse = (
  ...
  return {
    ...
    globals:
      overrides && overrides.hasOwnProperty('globals')
        ? overrides.globals!
        : [mockGlobalPythonModule()],
  };
};

export const mockListPoliciesInput = (
...
export const mockListPoliciesResponse = (
...
export const mockListResourcesInput = (
...
export const mockListResourcesResponse = (
...
export const mockListRulesInput = (overrides?: Partial<ListRulesInput>): ListRulesInput => {
  return {
    nameContains:
...
export const mockListRulesResponse = (
  overrides?: Partial<ListRulesResponse>
): ListRulesResponse => {
  return {
    __typename: 'ListRulesResponse',
    paging: overrides && overrides.hasOwnProperty('paging') ? overrides.paging! : mockPagingData(),
    rules: overrides && overrides.hasOwnProperty('rules') ? overrides.rules! : [mockRuleSummary()],
  };
};

export const mockModifyGlobalPythonModuleInput = (
...
export const mockMsTeamsConfig = (overrides?: Partial<MsTeamsConfig>): MsTeamsConfig => {
  return {
...
export const mockMsTeamsConfigInput = (
...
export const mockOpsgenieConfig = (overrides?: Partial<OpsgenieConfig>): OpsgenieConfig => {
  return {
...
export const mockOpsgenieConfigInput = (
...
export const mockOrganizationReportBySeverity = (
  ...
  return {
    ...
    info:
      overrides && overrides.hasOwnProperty('info')
        ...
        : mockComplianceStatusCounts(),
    low:
      overrides && overrides.hasOwnProperty('low') ? overrides.low! : mockComplianceStatusCounts(),
    medium:
...
export const mockOrganizationStatsInput = (
...
export const mockOrganizationStatsResponse = (
...
export const mockPagerDutyConfig = (overrides?: Partial<PagerDutyConfig>): PagerDutyConfig => {
  return {
...
export const mockPagerDutyConfigInput = (
...
export const mockPagingData = (overrides?: Partial<PagingData>): PagingData => {
  return {
...
export const mockPoliciesForResourceInput = (
...
export const mockPolicyDetails = (overrides?: Partial<PolicyDetails>): PolicyDetails => {
  return {
    ...
    tests:
      overrides && overrides.hasOwnProperty('tests') ? overrides.tests! : [mockPolicyUnitTest()],
    versionId:
      overrides && overrides.hasOwnProperty('versionId')
        ? overrides.versionId!
...
export const mockPolicySummary = (overrides?: Partial<PolicySummary>): PolicySummary => {
  return {
...
export const mockPolicyUnitTest = (overrides?: Partial<PolicyUnitTest>): PolicyUnitTest => {
  return {
...
export const mockPolicyUnitTestError = (
...
export const mockPolicyUnitTestInput = (
...
export const mockRemediateResourceInput = (
...
export const mockResourceDetails = (overrides?: Partial<ResourceDetails>): ResourceDetails => {
  return {
...
export const mockResourcesForPolicyInput = (
...
export const mockResourceSummary = (overrides?: Partial<ResourceSummary>): ResourceSummary => {
  return {
...
export const mockRuleDetails = (overrides?: Partial<RuleDetails>): RuleDetails => {
  return {
...
export const mockRuleSummary = (overrides?: Partial<RuleSummary>): RuleSummary => {
  return {
...
export const mockS3LogIntegration = (overrides?: Partial<S3LogIntegration>): S3LogIntegration => {
  return {
...
export const mockScannedResources = (overrides?: Partial<ScannedResources>): ScannedResources => {
  return {
    __typename: 'ScannedResources',
    byType:
      overrides && overrides.hasOwnProperty('byType')
        ? overrides.byType!
        : [mockScannedResourceStats()],
  };
};

export const mockScannedResourceStats = (
...
export const mockSlackConfig = (overrides?: Partial<SlackConfig>): SlackConfig => {
  return {
...
export const mockSlackConfigInput = (overrides?: Partial<SlackConfigInput>): SlackConfigInput => {
  return {
    webhookURL:
...
export const mockSnsConfig = (overrides?: Partial<SnsConfig>): SnsConfig => {
  return {
...
export const mockSnsConfigInput = (overrides?: Partial<SnsConfigInput>): SnsConfigInput => {
  return {
    topicArn: overrides && overrides.hasOwnProperty('topicArn') ? overrides.topicArn! : 'voluptas',
  };
};

export const mockSqsConfig = (overrides?: Partial<SqsConfig>): SqsConfig => {
  return {
...
export const mockSqsConfigInput = (overrides?: Partial<SqsConfigInput>): SqsConfigInput => {
  return {
    queueUrl: overrides && overrides.hasOwnProperty('queueUrl') ? overrides.queueUrl! : 'et',
  };
};

export const mockSuppressPoliciesInput = (
...
export const mockTestPolicyInput = (overrides?: Partial<TestPolicyInput>): TestPolicyInput => {
  return {
...
export const mockTestPolicyResponse = (
  ...
  return {
    ...
    testsErrored:
      overrides && overrides.hasOwnProperty('testsErrored')
        ...
        : [mockPolicyUnitTestError()],
  };
};

export const mockUpdateComplianceIntegrationInput = (
...
export const mockUpdateGeneralSettingsInput = (
...
export const mockUpdatePolicyInput = (
...
export const mockUpdateRuleInput = (overrides?: Partial<UpdateRuleInput>): UpdateRuleInput => {
  return {
...
export const mockUpdateS3LogIntegrationInput = (
...
export const mockUploadPoliciesInput = (
...
export const mockUploadPoliciesResponse = (

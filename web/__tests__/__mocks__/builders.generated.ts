...
export const buildAlertDetails = (overrides?: Partial<AlertDetails>): AlertDetails => {
  return {
    ...
    title: 'Steel',
    creationTime: '2019-10-27T00:06:29.865Z',
    updateTime: '2019-02-20T02:54:35.910Z',
    eventsMatched: 516,
    events: ['"bar"'],
...
export const buildAlertSummary = (overrides?: Partial<AlertSummary>): AlertSummary => {
  return {
    ...
    creationTime: '2019-08-07T10:15:31.121Z',
    eventsMatched: 670,
    title: 'indexing',
    updateTime: '2019-09-16T17:32:46.882Z',
...
export const buildComplianceIntegration = (
  ...
  return {
    ...
    createdAtTime: '2019-11-22T14:57:57.973Z',
...
export const buildComplianceItem = (overrides?: Partial<ComplianceItem>): ComplianceItem => {
  return {
    ...
    lastUpdated: '2019-10-28T13:59:39.128Z',
...
export const buildDestination = (overrides?: Partial<Destination>): Destination => {
  return {
    ...
    creationTime: '2019-07-31T17:40:18.778Z',
    displayName: 'Accountability',
    lastModifiedBy: 'Tasty Granite Bike',
    lastModifiedTime: '2019-07-04T04:23:49.280Z',
...
export const buildGlobalPythonModule = (
  ...
  return {
    ...
    createdAt: '2019-02-05T04:16:18.558Z',
    lastModified: '2019-01-25T00:38:32.897Z',
    ...overrides,
...
export const buildListAlertsInput = (overrides?: Partial<ListAlertsInput>): ListAlertsInput => {
  return {
    ...
    nameContains: 'Island',
    createdAtBefore: '2019-05-21T10:33:45.819Z',
    createdAtAfter: '2019-04-25T11:02:02.091Z',
...
export const buildPolicySummary = (overrides?: Partial<PolicySummary>): PolicySummary => {
  return {
    ...
    lastModified: '2019-09-09T23:58:47.481Z',
    resourceTypes: ['EXE'],
    severity: SeverityEnum.Critical,
    tags: ['navigating'],
    ...overrides,
...
export const buildResourceDetails = (overrides?: Partial<ResourceDetails>): ResourceDetails => {
  return {
    ...
    complianceStatus: ComplianceStatusEnum.Pass,
    lastModified: '2019-04-21T11:19:24.499Z',
    type: 'Ball',
    ...overrides,
...
export const buildResourceSummary = (overrides?: Partial<ResourceSummary>): ResourceSummary => {
  return {
    ...
    complianceStatus: ComplianceStatusEnum.Pass,
    deleted: false,
    lastModified: '2019-09-26T21:50:08.966Z',
    type: 'Illinois',
    ...overrides,
...
export const buildRuleDetails = (overrides?: Partial<RuleDetails>): RuleDetails => {
  return {
    body: 'Shoes',
    createdAt: '2019-08-02T03:47:47.012Z',
    ...
    enabled: false,
    id: 'Metal',
    lastModified: '2019-01-30T01:09:25.999Z',
...
export const buildRuleSummary = (overrides?: Partial<RuleSummary>): RuleSummary => {
  return {
    ...
    lastModified: '2019-10-10T21:20:19.662Z',
    logTypes: ['AI'],
...
export const buildS3LogIntegration = (overrides?: Partial<S3LogIntegration>): S3LogIntegration => {
  return {
    ...
    createdAtTime: '2019-07-02T06:10:02.259Z',
    ...
    lastEventReceived: '2019-05-24T07:20:29.138Z',
    s3Bucket: 'generating',
    s3Prefix: 'IB',
    kmsKey: 'robust',
    logTypes: ['strategize'],

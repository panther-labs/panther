...
const StackDeployment: React.FC = () => {
  ...
  const cfnConsoleLink =
    ...
    `?templateURL=https://s3-us-west-2.amazonaws.com/panther-public-cloudformation-templates/panther-cloudsec-iam/${QUALIFIED_PANTHER_PATCH_VERSION}/template.yml` +
    `&stackName=${stackName}` +

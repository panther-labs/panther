...
import { QUALIFIED_PANTHER_PATCH_VERSION } from 'Source/constants';
...
const StackDeployment: React.FC = () => {
  ...
  const cfnConsoleLink =
    ...
    `?templateURL=https://panther-public-cloudformation-templates.s3-us-west-2.amazonaws.com/panther-log-analysis-iam/${QUALIFIED_PANTHER_PATCH_VERSION}/template.yml` +
    `&stackName=${stackName}` +

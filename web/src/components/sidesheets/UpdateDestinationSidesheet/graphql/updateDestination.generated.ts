...
export type UpdateDestination = { updateDestination?: Types.Maybe<(
...
export const UpdateDestinationDocument = gql`
  ...
  updateDestination(input: $input) {
    ...
    `;
export type UpdateDestinationMutationFn = ApolloReactCommon.MutationFunction<UpdateDestination, UpdateDestinationVariables>;
 ...
 * });
 */
export function useUpdateDestination(baseOptions?: ApolloReactHooks.MutationHookOptions<UpdateDestination, UpdateDestinationVariables>) {
        return ApolloReactHooks.useMutation<UpdateDestination, UpdateDestinationVariables>(UpdateDestinationDocument, baseOptions);
      }
...
export type UpdateDestinationMutationOptions = ApolloReactCommon.BaseMutationOptions<UpdateDestination, UpdateDestinationVariables>;

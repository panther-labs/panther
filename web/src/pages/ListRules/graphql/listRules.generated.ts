...
export type ListRules = { rules?: Types.Maybe<{ rules?: Types.Maybe<Array<Types.Maybe<Pick<Types.RuleSummary, 'lastModified' | 'logTypes' | 'severity' | 'id' | 'displayName' | 'enabled'>>>>, paging?: Types.Maybe<Pick<Types.PagingData, 'totalPages' | 'thisPage' | 'totalItems'>> }> };
 ...
 * });
 */
export function useListRules(baseOptions?: ApolloReactHooks.QueryHookOptions<ListRules, ListRulesVariables>) {
        return ApolloReactHooks.useQuery<ListRules, ListRulesVariables>(ListRulesDocument, baseOptions);
      }
export function useListRulesLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<ListRules, ListRulesVariables>) {
          return ApolloReactHooks.useLazyQuery<ListRules, ListRulesVariables>(ListRulesDocument, baseOptions);
        }

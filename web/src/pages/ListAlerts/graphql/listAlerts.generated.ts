...
export type ListAlerts = { alerts?: Types.Maybe<(
    Pick<Types.ListAlertsResponse, 'lastEvaluatedKey'>
    & { alertSummaries: Array<Types.Maybe<Pick<Types.AlertSummary, 'alertId' | 'creationTime' | 'eventsMatched' | 'updateTime' | 'ruleId' | 'severity'>>> }
  )> };
 ...
 * });
 */
export function useListAlerts(baseOptions?: ApolloReactHooks.QueryHookOptions<ListAlerts, ListAlertsVariables>) {
        return ApolloReactHooks.useQuery<ListAlerts, ListAlertsVariables>(ListAlertsDocument, baseOptions);
      }
export function useListAlertsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<ListAlerts, ListAlertsVariables>) {
          return ApolloReactHooks.useLazyQuery<ListAlerts, ListAlertsVariables>(ListAlertsDocument, baseOptions);
        }

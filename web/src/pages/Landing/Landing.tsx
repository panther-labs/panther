        ...
        <Card mb={6} is="section">
          <Grid gridTemplateColumns="repeat(3, 1fr)" py={5}>
            ...
            <Flex flexDirection="column" alignItems="center" justifyContent="center" px={10} py={5}>
              ...
              <Text size="medium" is="p" color="grey300" textAlign="center" maxWidth={250}>
                View your AWS resources and monitor their compliance with your Cloud Security policies
              </Text>
              <Text
                color="blue300"
                p={4}
            ...
            <Flex flexDirection="column" alignItems="center" justifyContent="center" px={10} py={5}>
              ...
              <Text size="medium" is="p" color="grey300" textAlign="center" maxWidth={250}>
                Use AWS Athena to write complex queries against your normalized log data
              </Text>
              <Text
                color="blue300"
                p={4}

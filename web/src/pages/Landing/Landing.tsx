        ...
        <Card mb={6} p={4} as="section">
          <SimpleGrid columns={3} py={5}>
            <Flex direction="column" align="center" justify="center">
              ...
              <Button variantColor="teal" as={RRLink} to={urls.settings.users()}>
                Manage Users
              </Button>
            </Flex>
            <Flex direction="column" justify="center" align="center">
              ...
              <Button variantColor="teal" as={RRLink} to={urls.compliance.sources.create()}>
            ...
            <Flex direction="column" justify="center" align="center">
              ...
              <Button variantColor="teal" as={RRLink} to={urls.logAnalysis.sources.create()}>
                Connect S3 Buckets
              </Button>
            </Flex>
          </SimpleGrid>
        ...
        <Card mb={6} p={4} as="section">
          <SimpleGrid columns={3} py={5}>
            <Flex direction="column" align="center" justify="center">
              ...
              <Button variantColor="red" as={RRLink} to={urls.settings.destinations()}>
                Setup Destinations
              </Button>
            </Flex>
            ...
            <Flex direction="column" align="center" justify="center">
              ...
              <Button variantColor="red" as={RRLink} to={urls.compliance.policies.create()}>
                Create a Policy
              </Button>
            </Flex>
            <Flex direction="column" align="center" justify="center">
              ...
              <Button variantColor="red" as={RRLink} to={urls.logAnalysis.rules.create()}>
                Create a Rule
              </Button>
            </Flex>
          </SimpleGrid>
        ...
        <Card as="section" p={4}>
          <SimpleGrid columns={3} py={5}>
            <Flex direction="column" align="center" justify="center">
              ...
              <Button as={RRLink} to={urls.logAnalysis.alerts.list()}>
                View Alerts
              </Button>
            </Flex>
            <Flex direction="column" align="center" justify="center">
              ...
              <Button as={RRLink} to={urls.compliance.resources.list()}>
                View Resources
              </Button>
            </Flex>
            <Flex direction="column" align="center" justify="center">
      ...
      <Box py={10}>
        ...
        <SimpleGrid columns={3} py={5} spacing={6}>
          <Card p={7} as="article" fontSize="medium">
            ...
            <Text size="medium" as="p" color="gray-200" mb={3}>

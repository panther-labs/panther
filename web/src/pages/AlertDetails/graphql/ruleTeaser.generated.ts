...
export type RuleTeaser = { rule?: Types.Maybe<Pick<Types.RuleDetails, 'description' | 'displayName' | 'id' | 'logTypes' | 'runbook' | 'severity' | 'tags'>> };
 ...
 * });
 */
export function useRuleTeaser(baseOptions?: ApolloReactHooks.QueryHookOptions<RuleTeaser, RuleTeaserVariables>) {
        return ApolloReactHooks.useQuery<RuleTeaser, RuleTeaserVariables>(RuleTeaserDocument, baseOptions);
      }
export function useRuleTeaserLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<RuleTeaser, RuleTeaserVariables>) {
          return ApolloReactHooks.useLazyQuery<RuleTeaser, RuleTeaserVariables>(RuleTeaserDocument, baseOptions);
        }

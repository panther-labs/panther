...
export type ListDestinationsAndDefaults = { destinations?: Types.Maybe<Array<Types.Maybe<(
 ...
 * });
 */
export function useListDestinationsAndDefaults(baseOptions?: ApolloReactHooks.QueryHookOptions<ListDestinationsAndDefaults, ListDestinationsAndDefaultsVariables>) {
        return ApolloReactHooks.useQuery<ListDestinationsAndDefaults, ListDestinationsAndDefaultsVariables>(ListDestinationsAndDefaultsDocument, baseOptions);
      }
export function useListDestinationsAndDefaultsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<ListDestinationsAndDefaults, ListDestinationsAndDefaultsVariables>) {
          return ApolloReactHooks.useLazyQuery<ListDestinationsAndDefaults, ListDestinationsAndDefaultsVariables>(ListDestinationsAndDefaultsDocument, baseOptions);
        }
export type ListDestinationsAndDefaultsHookResult = ReturnType<typeof useListDestinationsAndDefaults>;
export type ListDestinationsAndDefaultsLazyQueryHookResult = ReturnType<typeof useListDestinationsAndDefaultsLazyQuery>;
export type ListDestinationsAndDefaultsQueryResult = ApolloReactCommon.QueryResult<ListDestinationsAndDefaults, ListDestinationsAndDefaultsVariables>;

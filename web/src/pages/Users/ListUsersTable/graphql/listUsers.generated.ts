...
export type ListUsers = { users?: Types.Maybe<(
    Pick<Types.ListUsersResponse, 'paginationToken'>
    & { users?: Types.Maybe<Array<Types.Maybe<Pick<Types.User, 'id' | 'email' | 'givenName' | 'familyName' | 'createdAt' | 'status'>>>> }
  )> };
 ...
 * });
 */
export function useListUsers(baseOptions?: ApolloReactHooks.QueryHookOptions<ListUsers, ListUsersVariables>) {
        return ApolloReactHooks.useQuery<ListUsers, ListUsersVariables>(ListUsersDocument, baseOptions);
      }
export function useListUsersLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<ListUsers, ListUsersVariables>) {
          return ApolloReactHooks.useLazyQuery<ListUsers, ListUsersVariables>(ListUsersDocument, baseOptions);
        }

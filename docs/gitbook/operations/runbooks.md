...
## panther-ctas-workflow
The `panther-ctas-workflow` is a Step Functions state machine used execute Athena CTAS for Parquet generation.

 Failure Impact
 * Failure of this state machine will stop processing JSON into Parquet.

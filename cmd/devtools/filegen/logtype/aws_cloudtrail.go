...
func (ct *AWSCloudTrail) fillEvent(event *awslogs.CloudTrail, hour time.Time) {
	event.AdditionalEventData = cloudTrailAdditionalEventData
	...
	event.RequestParameters = cloudTrailRequestParameters
	...
	event.ResponseElements = cloudTrailResponceElements
	event.ServiceEventDetails = cloudTrailServiceEventDetails
...
var (
	...
	cloudTrailServiceEventDetails = pantherlog.RawMessage(`{"serviceEvent":1234}`)
)

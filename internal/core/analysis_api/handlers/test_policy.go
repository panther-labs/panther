...
// TestPolicyOrRule runs a policy (or rule) against a set of unit tests.
func TestPolicyOrRule(request *events.APIGatewayProxyRequest) *events.APIGatewayProxyResponse {

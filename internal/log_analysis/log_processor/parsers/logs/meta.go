...
// MustRegisterPrefixMeta registers a custom MetaFactory for a log type prefix.
func MustRegisterPrefixMeta(prefix string, fac MetaFactory) {
	if fac == nil {

...
func TestCloudTrailLogGenerateDataKey(t *testing.T) {
	...
	event := &CloudTrail{
		...
		EventTime:       (*timestamp.RFC3339)(&tm),
...
func TestCloudTrailLogDecrypt(t *testing.T) {
	...
	testutil.CheckPantherEvent(t, event, TypeCloudTrail, tm,
		KindAWSARN.Field("arn:aws:kms:us-east-1:888888888888:key/90be6df2-db60-4237-ad9b-a49260XXXXX"),
		KindAWSARN.Field("arn:aws:iam::888888888888:role/panther-app-LogProcessor-XXXXXXXXXXXX-FunctionRole-XXXXXXXXXX"),
		KindAWSARN.Field("arn:aws:sts::888888888888:assumed-role/panther-app-LogProcessor-XXXXXXXXXXXX-FunctionRole-XXXXXXXXXX/panther-log-processor"),
		KindAWSAccountID.Field("888888888888"),
		parsers.KindIPAddress.Field("1.2.3.4"),
	)
	testutil.CheckPantherParserJSON(t, log, &CloudTrailParser{}, event)
}
...
func TestCloudTrailLogType(t *testing.T) {
	...
	require.Equal(t, TypeCloudTrail, parser.LogType())
}

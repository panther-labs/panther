...
type CloudTrailInsight struct {
	...
	EventType          *string            `json:"eventType" validate:"required" description:"Identifies the type of event that generated the event record. This can be the one of the following values: AwsApiCall, AwsServiceEvent, AwsConsoleSignIn"`
...
type InsightDetails struct {
	...
	InsightType    *string         `json:"insightType" validate:"required,eq=ApiCallRateInsight" description:"The type of Insights event. Value is ApiCallRateInsight. "`

...
type CloudTrail struct {
	AdditionalEventData *object.Object          `json:"additionalEventData,omitempty" description:"Additional data about the event that was not part of the request or response."`
	...
	RequestParameters   *object.Object          `json:"requestParameters,omitempty" description:"The parameters, if any, that were sent with the request. These parameters are documented in the API reference documentation for the appropriate AWS service."`
	Resources           []CloudTrailResources   `json:"resources,omitempty" description:"A list of resources accessed in the event."`
	ResponseElements    *object.Object          `json:"responseElements,omitempty" description:"The response element for actions that make changes (create, update, or delete actions). If an action does not change state (for example, a request to get or list objects), this element is omitted. These actions are documented in the API reference documentation for the appropriate AWS service."`
	ServiceEventDetails *object.Object          `json:"serviceEventDetails,omitempty" description:"Identifies the service event, including what triggered the event and the result."`
...
type CloudTrailSessionContextWebIDFederationData struct {
	...
	Attributes        *object.Object `json:"attributes,omitempty"`
}

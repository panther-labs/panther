...
type CloudTrail struct {
	...
	APIVersion          *string                 `json:"apiVersion,omitempty" validate:"required" description:"Identifies the API version associated with the AwsApiCall eventType value."`
	...
	EventName           *string                 `json:"eventName,omitempty" description:"The requested action, which is one of the actions in the API for that service."`
	EventSource         *string                 `json:"eventSource,omitempty" description:"The service that the request was made to. This name is typically a short form of the service name without spaces plus .amazonaws.com."`
	EventTime           *timestamp.RFC3339      `json:"eventTime,omitempty" description:"The date and time the request was made, in coordinated universal time (UTC)."`
	EventType           *string                 `json:"eventType,omitempty" description:"Identifies the type of event that generated the event record. This can be the one of the following values: AwsApiCall, AwsServiceEvent, AwsConsoleSignIn"`
	...
	UserIdentity        *CloudTrailUserIdentity `json:"userIdentity,omitempty" description:"Information about the user that made a request."`

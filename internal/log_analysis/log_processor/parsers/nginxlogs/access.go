...
type Access struct {
	...
	RemoteUser    *string            `json:"remoteUser,omitempty" description:"The userid of the person making the request. Usually "-" unless .htaccess has requested authentication"`

...
type AdministratorLog struct {
	...
	Action       pantherlog.String `json:"action" validate:"required" validate:"excludes=o2fa_user_provisioned o2fa_user_deprovisioned o2fa_user_reenrolled" description:"The type of change that was performed."`

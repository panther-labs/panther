...
class TestEngine(TestCase):
    ...
    def test_analyse_many_rules(self) -> None:
        ...
        expected_event_matches = [
            EventMatch(rule_id='rule_id_1', rule_version='version', log_type='log', severity='INFO', dedup='<nil>', event={})
        ]
    ...
    def test_analyse_many_rules_one_throws_exception(self) -> None:
        ...
        expected_event_matches = [
            EventMatch(rule_id='rule_id_1', rule_version='version', log_type='log', severity='INFO', dedup='<nil>', event={}),
            EventMatch(rule_id='rule_id_3', rule_version='version', log_type='log', severity='INFO', dedup='<nil>', event={})
        ]
